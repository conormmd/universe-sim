...
pbar=ProgressBar()
plt.scatter(planets[0][0,0], planets[0][0,1], label='Sun')
plt.scatter(planets[1][0,0], planets[1][0,1], color='black',label='Jupiter')
for i in pbar(range(0,N_asteroids)):
    plt.scatter(asteroids[i][0,0], asteroids[i][0,1])
