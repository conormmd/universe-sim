...
ast_legend = plt.legend(handles=hidden_ast, loc=[0.64,0.915])
...
ax_distance.set_yticks([0,0.5,1,1.5,2,2.5])
ax_distance.set_yticklabels(['0','','${R}_{J}$','','2${R}_{J}$'])
ax_distance.set_xticks([0,5*P/100000,10*P/100000,15*P/100000,20*P/100000,25*P/100000])
ax_distance.set_xticklabels(['0','5${P}_{J}$','10${P}_{J}$','15${P}_{J}$','20${P}_{J}$','25${P}_{J}$',])

distance = np.load('distance.npy')
distance = distance/r_J
x_distance = []
y_distance = []
...
animation.save('animation_HS.gif',writer='imagemagick', fps=60)
#plt.show()
